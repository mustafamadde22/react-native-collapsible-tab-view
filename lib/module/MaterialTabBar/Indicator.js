...
const Indicator = ({
  ...
  const stylez = useAnimatedStyle(() => {
    ...
    const width = itemsLayout.length > 1 ? interpolate(indexDecimal.value, itemsLayout.map((_, i) => i), itemsLayout.map(v => v.width - 32)) : ((_itemsLayout$ = itemsLayout[0]) === null || _itemsLayout$ === void 0 ? void 0 : _itemsLayout$.width) - 32;
    return {
      transform,
      width,
